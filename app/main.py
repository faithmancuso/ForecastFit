...
def subscribe():
    ...
    # Create a shortened URL for detailed recommendations
    shortened_url = "https://bit.ly/your-shortened-url"  # Replace with your actual shortened URL

    # Prepare the SMS message with the shortened URL
    sms_message = (
        ...
        f"For detailed clothing recommendations, visit: {shortened_url}"
    )
